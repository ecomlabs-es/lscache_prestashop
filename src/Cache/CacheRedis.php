 ...
 *
 * Connection settings come from src/Cache/redis_parameters_autoloader.php (generated by
...
class CacheRedis extends \CacheCore
{
    ...
    protected function connect(): void
    {
        ...
        $configFile = defined('_PS_MODULE_DIR_')
            ? _PS_MODULE_DIR_ . 'litespeedcache/src/Cache/redis_parameters_autoloader.php'
            : '';
